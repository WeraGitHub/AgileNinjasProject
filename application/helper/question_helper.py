...
from application.objects.question import \
    Question  # Import the 'Question' class from the 'application.objects.question' module
...
def add_question_to_db(question, answer, category):
    ...
    cursor.execute('INSERT INTO questions (question, answer, category) VALUES (%s, %s, %s)',
...
def update_question_in_db(id, question, answer, category):
    ...
    cursor.execute('UPDATE questions SET question=%s, answer=%s, category=%s WHERE id=%s',
